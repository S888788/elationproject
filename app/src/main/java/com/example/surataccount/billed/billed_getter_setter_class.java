...
public class billed_getter_setter_class {
    ...
    public billed_getter_setter_class(String vouchernumber, String voucherdate, String studioCode, String studioname, String amtPayable, String amtRecieved) {
